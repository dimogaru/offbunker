...
export const GetSharedTripResponse = zod.object({
  ...
  rentals: zod.array(
    zod.object({
      ...
      departureDateTime: zod.coerce.date().nullish(),
      arrivalDateTime: zod.coerce.date().nullish(),
      transportNumber: zod.string().nullish(),
      seatInfo: zod.string().nullish(),
...
export const CreateRentalBody = zod.object({
  ...
  originStation: zod.string().optional(),
  destinationStation: zod.string().optional(),
  departureDateTime: zod.coerce.date().optional(),
  arrivalDateTime: zod.coerce.date().optional(),
  transportNumber: zod.string().optional(),
  seatInfo: zod.string().optional(),
